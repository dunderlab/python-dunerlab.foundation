...
def ping_url(url, time_):
    global client_time_1, sever_time_1, server_time_2, control
    ...
    if response.status_code == 200:
        ...
        server_time = float(resp['server_timestamp'])
    ...
    server_time_2 = server_time - sever_time_1 - T
    client_time_1 = client_time
    sever_time_1 = server_time
...
while True:
    ping_url('http://192.168.161.22:51102/timescaledbapp/', time.ticks_ms())
    # ping_url('http://192.168.1.54:51102/timescaledbapp/', time.ticks_ms())
    # ping_url('http://192.168.1.54:51102/timescaledbapp/', time.ticks_ms())
    time.sleep(T)
